...
class DQN(nn.Module):
    def __init__(self, lr, input_dims, fc1_dims, fc2_dims, n_actions, chkpt_dir='tmp/dqn'):
        ...
        self.to(self.device)
        self.checkpoint_dir = os.getcwd().split("/P10-XRL/")[0] + "/P10-XRL/GymEnvironments/P10-RL-LvL3-Grasping-Combined/P10_DRL_Lvl3_Grasping_Combined/envs/" + chkpt_dir
...
class P10_DRL_Lvl3_Grasping_Combined(gym.Env):
    ...
    def __init__(self, itername, vdist, plt_avg):
        ...
        self.own_path = os.getcwd().split("/P10-XRL/")[0] + "/P10-XRL/GymEnvironments/P10-RL-LvL3-Grasping-Combined/P10_DRL_Lvl3_Grasping_Combined/envs/P10_DRL_Lvl3_Grasping_Combined.py"
        self.id = "DQN - " + str(datetime.now())[:-7].replace(':','_') + 'P10_DRL_Lvl3_Grasping_Combined' + itername
        ...
        self.conveyor_speeds = [x/100 for x in range(10,60)]
        ...
        self.counter = 0
        self.waitingTs = 3  # The number of timesteps it needs to wait after an operation (to make sure the physics catches up)
        self.actionScale = 3
    ...
    def step(self, action):
        ...
        #graspState = self.getState(mode="grasp")
        #graspAction = self.grasp(graspState)
    ...
    def _setTarget(self):
        ...
        self.target_x = random.uniform(0.2, 1.2)
        #self.target_x = random.uniform(0.2, 0.2)
        ...
        if self.test: print("... at {}".format(self.target_x*100))
